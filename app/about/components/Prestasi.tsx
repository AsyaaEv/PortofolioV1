        ...
        <>
            <main className="w-full flex-col mt-8 dark:text-white border-b-2 pb-4 dark:border-white/15">
                ...
                <section className="w-full grid grid-cols-1 gap-4 mt-4 md:grid-cols-2">
                    <Card 
                        image="/prestasi/pPramukaMI.jpeg"
